...
generating a quote image and idles near zero otherwise, and the whole thing (bot + venv + built front + all dependencies) takes up roughly 220MB of disk. Nothing exotic here,
